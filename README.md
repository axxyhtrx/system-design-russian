...
В этой стратегии мы разбиваем данные таблицы по горизонтали на основе диапазона значений, определяемого _ключом раздела_. Ее также называют **_разбиением базы данных на части_**.
...
- **Код по требованию**: Возвращение исполняемого кода для поддержки части вашего приложения. _(необязательно)_
...
Я настоятельно рекомендую изучить [Hypermedia as the Engine of Application State (HATEOAS)](https://en.wikipedia.org/wiki/HATEOAS). _Так много еще предстоит узнать, когда речь идет о REST API._
...
_Все диаграммы были сделаны с помощью [Excalidraw](https://excalidraw.com) и доступны [здесь](https://github.com/karanpratapsingh/system-design/tree/main/diagrams)._
